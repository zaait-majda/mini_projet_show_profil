...
// fonction pour telecharger le recu
      unduhPdf(e){
       ...
       //doc.addImage('file:///D:/front_youssef/miniprojet1//uploads/team-3.jpg', 'jpg', 0.5, 2, 2.5, 2.5)
      ...
      render() {
        ...
        <div className="styleTab">
          <h4 className="h4">Votre Informations</h4>
     
          
         
          <br></br>
           <table >
             <tr className="trStyle"><th>Le Code massar</th><th  className="esp">{this.state.massar}</th></tr>
           ...
           <Button type="primary" onClick={this.unduhPdf.bind(this)}>Imprimer votre recu</Button>
           <br></br><br></br>
